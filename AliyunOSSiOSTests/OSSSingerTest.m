...
- (void)test_singerWithSignerV4Presign {
    ...
    XCTAssertTrue([@"ce55e10e546688b0f2d388823029de98a79fbec965a1bf33af6d1bc9f4924086" isEqualToString:requestMessage.params[@"x-oss-signature"]]);
...
- (void)test_singerWithSignerV4PresignToken {
    ...
    XCTAssertTrue([@"599" isEqualToString:requestMessage.params[@"x-oss-expires"]]);
    XCTAssertTrue([@"ak/20231216/cn-hangzhou/oss/aliyun_v4_request" isEqualToString:requestMessage.params[@"x-oss-credential"]]);
    XCTAssertTrue([@"b4d1e44984bc0d876c0414cc4afcb8ad343ccd7748e95a8fb3398a0576db7f96" isEqualToString:requestMessage.params[@"x-oss-signature"]]);
